...
nucmer --maxmatch -l ${length} --delta=${TMPDIR}/${file}_1.nucmer.rDNA.delta --threads=16 ${rDNA_reference} ${TMPDIR}/${file}_1.fasta
nucmer --maxmatch -l ${length} --delta=${TMPDIR}/${file}_2.nucmer.rDNA.delta --threads=16 ${rDNA_reference} ${TMPDIR}/${file}_2.fasta
...
seqkit grep -f ${TMPDIR}/${file}.R1_read_ids.out ${TMPDIR}/${file}.R1.sorted.fastq.gz -j 16 | gzip > ${output_folder}/${file}_1.rDNA_reads.fastq.gz
seqkit grep -f ${TMPDIR}/${file}.R2_read_ids.out ${TMPDIR}/${file}.R2.sorted.fastq.gz -j 16 | gzip > ${output_folder}/${file}_2.rDNA_reads.fastq.gz
